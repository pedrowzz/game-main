...
public enum ParticleEffect {
     ...
     * </ul>
     */
    ELECTRIC_SPARK(version -> version < 17 ? "NONE" : "electric_spark", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    GLOW(version -> version < 17 ? "NONE" : "glow", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    GLOW_SQUID_INK(version -> version < 17 ? "NONE" : "glow_squid_ink", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    REVERSE_PORTAL(version -> version < 16 ? "NONE" : "reverse_portal", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SCRAPE(version -> version < 17 ? "NONE" : "scrape", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SNOWFLAKE(version -> version < 17 ? "NONE" : "snowflake", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SOUL(version -> version < 16 ? "NONE" : "soul", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    SOUL_FIRE_FLAME(version -> version < 16 ? "NONE" : "soul_fire_flame", PropertyType.DIRECTIONAL),
    /**
    ...
    VIBRATION(version -> version < 17 ? "NONE" : "vibration", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    WAX_OFF(version -> version < 17 ? "NONE" : "wax_off", PropertyType.DIRECTIONAL),
    /**
     ...
     * </ul>
     */
    WAX_ON(version -> version < 17 ? "NONE" : "wax_on", PropertyType.DIRECTIONAL),
    /**
    ...
    public boolean hasProperty(PropertyType propertyType) {
        return (propertyType != null && Arrays.<PropertyType>asList(this.properties).contains(propertyType));
    }
    ...
    public boolean isCorrectColor(ParticleColor color) {
        return (color instanceof RegularColor);
    }
    ...
    public void display(Location location, ParticleColor color, Player... players) {
        display(location, 0.0F, 0.0F, 0.0F, 1.0F, 0, (ParticleData) color, players);
    }

    public void display(Location location, Color color, Player... players) {
        display(location, (ParticleColor) new RegularColor(color), players);
    }

    public void display(Location location, ParticleColor color, Predicate<Player> filter) {
        display(location, 0.0F, 0.0F, 0.0F, 1.0F, 0, color, filter);
    }

    public void display(Location location, Color color, Predicate filter) {
        display(location, (ParticleColor) new RegularColor(color), filter);
    }
    ...
    public void display(Location location, ParticleColor color) {
        display(location, 0.0F, 0.0F, 0.0F, 1.0F, 0, (ParticleData) color);
    }

    public void display(Location location, Color color) {
        display(location, (ParticleColor) new RegularColor(color));
    }

    public void display(Location location, Player... players) {
        display(location, 0.0F, 0.0F, 0.0F, 0.0F, 1, (ParticleData) null, players);
    }

    public void display(Location location, Predicate<Player> filter) {
        display(location, 0.0F, 0.0F, 0.0F, 0.0F, 1, (ParticleData) null, filter);
    }
    ...
    public void display(Location location, float offsetX, float offsetY, float offsetZ, float speed, int amount, ParticleData data, Player... players) {
        ArrayList<Player> playerList = (ArrayList<Player>) Arrays.<Player>stream(players).collect(Collectors.toCollection(ArrayList::new));
    ...
    public void display(Location location, float offsetX, float offsetY, float offsetZ, float speed, int amount, ParticleData data, Predicate<Player> filter) {
        ArrayList<Player> players = (ArrayList<Player>) Bukkit.getOnlinePlayers().stream().filter(filter).collect(Collectors.toCollection(ArrayList::new));
