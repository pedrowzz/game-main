package com.minecraft.core.bukkit.util.selector;
...
import com.minecraft.core.bukkit.util.selector.opener.InventoryOpener;
...
public class SmartInventory {
    ...
    private final InventoryService manager;

    private SmartInventory(InventoryService manager) {
    ...
    public InventoryService getManager() {
        return manager;
    }
    ...
    public static final class Builder {
        ...
        private InventoryService manager;
        private InventoryProvider provider;
        private SmartInventory parent;
        ...
        public Builder manager(InventoryService manager) {
            this.manager = manager;
            return this;
        }
        ...
        public SmartInventory build() {
            ...
            InventoryService manager = this.manager != null ? this.manager : BukkitGame.getEngine().getInventoryService();
