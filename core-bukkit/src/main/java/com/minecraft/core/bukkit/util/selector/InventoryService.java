...
import com.minecraft.core.bukkit.util.selector.opener.ChestInventoryOpener;
import com.minecraft.core.bukkit.util.selector.opener.InventoryOpener;
import com.minecraft.core.bukkit.util.selector.opener.SpecialInventoryOpener;
...
public class InventoryService {
    ...
    public void init() {
        ...
        new InvTask().runTaskTimer(plugin, 10, 10);
    }
